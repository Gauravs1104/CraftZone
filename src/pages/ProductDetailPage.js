...
import './ProductDetailPage.css'; // Import the CSS for this page

// Temporarily copy the products array here. In a real app, this would come from a global state or API.
const products = [
  {
    id: 1,
    name: 'Coin Tree Art',
...
const ProductDetailPage = () => {
  ...
  return (
    <div className="product-detail-page container">
      <Link to="/products" className="btn btn-outline mb-3">← Back to Products</Link>
      <div className="product-detail-content">
        ...
        <div className="product-detail-info">
          ...
          <Link to="/contact" className="btn">Contact to Purchase</Link> {/* Changed to Contact to Purchase and linked to contact page */}
        </div>
      </div>
    </div>
  );
